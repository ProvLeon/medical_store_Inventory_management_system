...
$query = "SELECT t.*, p.name as person_name, p.address as person_address
...
if ($transaction) {
    ...
    $response = [
        ...
        'transaction' => [
            ...
            'person' => $transaction['person_name'] ? $transaction['person_name'] : 'N/A',
            'person_address' => $transaction['person_address'] ? $transaction['person_address'] : 'N/A',
            'items' => $items
        ]
    ];
} else {
